...
<img class="project-thumb" src="../../assets/monopol3d.PNG" alt="Optimisation d’un réseau d’antennes par RNA">
...
[Lire l'article (PDF)](../../assets/OptimreseauxantennesRNA/Synthese-Optim_reseaux_antennes_planaires.pdf){.btn .btn-primary}
...
<img class="project-thumb" src="../../assets/point_mesure.png" alt="Detection fingerptinting Wi-Fi">
...
J’ai formulé le problème comme une **régression supervisée** : \((RSSI_1,\dots,RSSI_4)\rightarrow(x,y)\), puis comparé un **réseau de neurones (MLP)** à un **PSO** en précision et en latence.
...
- **Baseline** : **PSO** (60 particules, \(c_1=c_2=2\), \(w\in[0.4,0.9]\), 1000 itérations)
...
**Pourquoi c’est fort pour un recruteur (Télécoms × Data).**
- Reformulation d’un problème radio en **pipeline ML** exploitable
- Analyse rigoureuse des compromis **latence vs précision**
- Comparaison structurée **ML vs optimisation heuristique**
- Approche directement transférable à **IoT / smart buildings / analytics radio**
...
<div class="project-links">
[Lire l'article (PDF)](../../assets/Detectionparfingerprinting/Synthese-Detection_par_fingerprinting.pdf){.btn .btn-primary}
...
<img class="project-thumb" src="../../assets/bayesian-optim1.png" alt="Optimisation bayésienne pour systèmes expérimentaux coûteux">
...
**Tech :** `Python` · `PyTorch` · `TensorFlow` · `NumPy` · `Pandas` · `Matplotlib` · `Robotique`

 <!-- rajoutons le liens youtube du projet -->
<div class="project-links">
